const PLAY_DIALOG_TURBO_VOICES_MAP: { [key: string]: string } = {
  ...
  's3://voice-cloning-zero-shot/324a553f-0935-4473-962a-5cd504b6b13d/original/manifest.json': 'Basil-PlayAI',
  ...
  's3://voice-cloning-zero-shot/8007f637-9aec-4426-8c6a-7e713c032623/original/manifest.json': 'Mitch-PlayAI',
